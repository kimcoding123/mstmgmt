...
<div class="popup-wrap" >
			...
			<div class="popup-head">
				...
				<div class="head-txt"><c:out value="${dmnLgcNm}"/> 조회(SCR009R)</div>
...
$(document).ready(function(){
	...
	// 기준항목참조(참조기준항목ID), 기준항목참조상세 
	function getCritmRefDtls(){
		//ajax로 땡겨온 데이터
		$.ajax({
			 url :"<c:url value='/srvcr/selectCritmRefDtls.ajax'/>"
	        ,type: "POST"
		    //,contentType:'application/json; charset=UTF-8'
	        ,data :{'dmnLgcNm' : dmnLgcNm}  // 입력값?
	        ,dataType: 'json'  	   
	        ,success : function(data){
	        	critmRefDtls = data.list;  
	        	//조회항목 생성
	        	setSearchCond();
	        	//검색조건중 단순코드 설정
	        	setSearchCondCode();
