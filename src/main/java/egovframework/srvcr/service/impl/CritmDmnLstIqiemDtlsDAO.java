...
@Repository("critmDmnLstIqiemDtlsDAO")
public class CritmDmnLstIqiemDtlsDAO extends EgovAbstractDAO {

	/**
	 * 기준항목도메인목록조회항목내역 조회
	 */
	public List selectCritmDmnLstIqiemDtls(Map map) throws Exception{
		return list("critmDmnLstIqiemDtls.selectCritmDmnLstIqiemDtls", map);
	}
	
	public List selectcritmDmnData(String sql) throws Exception{
		return list("critmDmnLstIqiemDtls.selectcritmDmnData", sql);
	}
}
